...
%OPENSCAD% gridfinity_basic_cup.scad -D length=2 -D width=1 -D height=2 -D numbchambers=1 -D fingerslide=true -o Renders/basic_cup_2x1x2.stl --export-format binstl
%PYTHON% canonicalize.py Renders/basic_cup_2x1x2.stl

%OPENSCAD% gridfinity_basic_cup.scad -D length=2 -D width=1 -D height=2 -D numbchambers=5 -D fingerslide=true -o Renders/divided_cup_2x1x2x5.stl --export-format binstl
%PYTHON% canonicalize.py Renders/divided_cup_2x1x2x5.stl

%OPENSCAD% gridfinity_basic_cup.scad -D length=2 -D width=1 -D height=3 -D numbchambers=5 -D fingerslide=true -D withLabel=true -o Renders/divided_cup_2x1x3x5.stl --export-format binstl
